...
gTextures = {
    ...
    ['flag_and_poles'] = love.graphics.newImage('graphics/flags.png')
}
...
gFrames = {
    ...
    --[flag_poles] = GenerateFlagPoleQuads(gTextures['flag_and_poles'])
    --[flags] = GenerateFlagQuads(gTextures['flag_and_poles'])
}
